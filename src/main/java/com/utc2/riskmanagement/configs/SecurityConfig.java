    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(request -> {
                    request
                            .requestMatchers(HttpMethod.POST, APIConStant.User.ENDPOINT)
                            .permitAll()
                            .requestMatchers(APIConStant.Auth.ENDPOINT.concat("/**"), "/ws/**")
                            .permitAll()
                            .requestMatchers(HttpMethod.GET, APIConStant.MasterData.ENDPOINT)
                            .permitAll()
                            .anyRequest()
                            .authenticated();
